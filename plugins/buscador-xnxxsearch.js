...
const handler = async (m, {text, usedPrefix, command}) => {
  if (!db.data.chats[m.chat].nsfw && m.isGroup) {
    return conn.reply(m.chat, `${emoji} uy bebé 👾 el  contenido *NSFW* está desactivado en este grupo.\n> Unos de mis amores administradores puede activarlo con el comando » *#nsfw on*`, m);
  }
