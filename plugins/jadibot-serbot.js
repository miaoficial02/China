...
let drm2 = ""
let rtx = 
"𝐕𝐋𝐀𝐃𝐈𝐋𝐄𝐍𝐀 𝘽𝙤𝙩 - 𝙎𝙪𝙗 𝘽𝙤𝙩 𝙈𝙤𝙙𝙤* ঔৣ✞\n" +
"[⚙️] Conexión de 𝐕𝐋𝐀𝐃𝐈𝐋𝐄𝐍𝐀 𝘽𝙤𝙩 Sub-Bot: *QR\n" +
"⚡ *Invocación  a 𝐕𝐋𝐀𝐃𝐈𝐋𝐄𝐍𝐀 𝘽𝙤𝙩 pa...* ☠️ para pasar su alma atu numero ...\n" +
...
"`3` » Escanea el * QR* para sincronizar tu alma con el bot\n" +
"⏳ *¡Alerta, bebe!* este QR se expirará en ⚠️ *45 segundos*...\n" +
"🧿 𝙎𝙄𝙎𝙏𝙀𝙈𝘼 ➤ [ QR ACTIVO ] — 𝙀𝙎𝘾𝘼𝙉𝙀𝘼 𝙔𝘼 ⚔️"
let rtx2 = 
"𝐕𝐋𝐀𝐃𝐈𝐋𝐄𝐍𝐀 𝘽𝙤𝙩 - 𝙎𝙪𝙗 𝘽𝙤𝙩* ঔৣ✞\n\n" +
"⌁ *Conexión de: CÓDIGO* ⌁\n\n" +
...
m?.chat ? await conn.sendMessage(m.chat, {text: args[0] ? `@${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `@${m.sender.split('@')[0]}, genial ya eres parte de nuestra familia 𝐕𝐋𝐀𝐃𝐈𝐋𝐄𝐍𝐀 𝘽𝙤𝙩 Sub-Bots.`, mentions: [m.sender]}, { quoted: m }) : ''
